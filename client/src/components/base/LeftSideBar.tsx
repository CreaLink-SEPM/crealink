...
function LeftSideBar() {
  return (
    <div className="w-[20%] text-center bottom-0">
      <div className="w-35 h-14 justify-center items-center inline-flex">
        <div className="self-stretch justify-center items-center inline-flex">
          <div className="absolute bottom-[50%] self-stretch px-6 py-5 bg-red-800 rounded-full shadow border border-black border-opacity-5 justify-center items-start gap-px inline-flex">
