                              ...
                              <div className="w-[360px] h-[430px]">
                                <div className="h-[430px]">
                                  <div className="relative w-[360px] h-[430px] rounded-[7px]">
                                    <div className="rounded-[8px] bg-[url(https://c.animaapp.com/n1QiTcNd/img/400983289-889270855965019-4991156490034155777-n-jpg@2x.png)] bg-cover bg-[50%_50%] absolute w-[360px] h-[430px] top-0 left-0" />
                                    <div className="rounded-[7px] border border-solid border-[#00000026] absolute w-[360px] h-[430px] top-0 left-0" />
                                  </div>
                                </div>
                              </div>
                            </div>
